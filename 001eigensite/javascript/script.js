...
document.querySelectorAll("#nav-li-about-me").forEach(label => {
    label.addEventListener('click', () => {
        ...
        + "<br>Mijn moedertaal is Nederlands, maar ik spreek ook Engels, Frans en een beetje Duits.</p>"
        + "<p>Ik ben momenteel vrijwillig digidokter voor de vzw digibanken. Ik help mensen met het gebruik van computer, laptop, tablet of gsm. Updates, virus en administratie behoren tot mijn taken.</p>"
        + "<p>Ik ben 53 jaar oud, gehuwd met een heel lieve vrouw en stiefvader van 4 kinderen."
        + "<br>Nu de kinderen het huis uit zijn, heb ik veel tijd over en slaat de verveling vaak toe."
        + "<br>Dus leer ik programmeren</p>"
        + "<span>momenteel leer ik de volgende  \"talen\":</span>"
        + "<ul id=\"language-ul\">"
        + "<li>HTML (niet echt een programmeer taal)</li>"
        + "<li>CSS (ook niet echt een programmeer taal)</li>"
        + "<li>Javascript</li>"
        + "<li>PHP</li>"
        + "<li>MySQL (relational database management system)</li>"
        + "</ul>"
        + "<span>Boeken die ik momenteel aan het lezen ben:</span>"
        + "<ul id=\"books-ul\">"
